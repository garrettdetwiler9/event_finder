...
const achievements = [
  { id: 1, title: "Social Butterfly", description: "Attend 10 events", progress: 70, current: 7, goal: 10, icon: Users, color: "purple" },
  { id: 2, title: "Event Host", description: "Host 5 events", progress: 80, current: 4, goal: 5, icon: Star, color: "pink" },
  { id: 3, title: "Weekly Warrior", description: "Attend events 4 weeks in a row", progress: 50, current: 2, goal: 4, icon: TrendingUp, color: "orange" },
  { id: 4, title: "Category Explorer", description: "Try 8 different categories", progress: 62, current: 5, goal: 8, icon: Award, color: "purple" },
];
